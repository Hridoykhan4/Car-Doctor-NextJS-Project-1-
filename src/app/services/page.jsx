...
const ServicePage = async () => {
    // MongoDB থেকে সার্ভিস ডাটা ফেচ করা
    const serviceCollection = await dbConnect(collectionNamesObj.serviceCollection);
                    ...
                    services.map((service) => {
                        ...
                        return (
                            ...
                            >
                                <div>
                                    {/* Image Container */}
                                    <div className="relative w-full h-52 md:h-56 overflow-hidden rounded-lg bg-[var(--color-dark-07)]">
                                        <Image
                                            fill
                                            src={service.img}
                                            alt={service.title}
                                    ...
                                    {/* Title */}
                                    <h3 className="text-xl font-bold text-[var(--color-dark-02)] mt-5 line-clamp-1">
                                        {service.title}
                                    </h3>
                                </div>

                                {/* Footer / Price & Action */}
                                <div className="flex items-center justify-between pt-4 mt-2 border-t border-base-200">
                                    ...
                                    <Link
                                        ...
                                        className="p-3 text-(--color-primary) bg-base-200/50 group-hover:bg-(--color-primary) group-hover:text-white rounded-full transition-all duration-300 transform group-hover:-rotate-45 z-20"
                                    >
