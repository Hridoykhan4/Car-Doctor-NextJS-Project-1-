        ...
        <section className="app-container py-8">
            ...
            <div className="relative w-full h-60 sm:h-72 md:h-80 rounded-xl overflow-hidden mb-12">
                ...
                <div
                    ...
                    className="absolute bottom-0 left-1/2 -translate-x-1/2 bg-[var(--color-primary)] text-white px-8 py-2 font-medium text-sm md:text-base"
                >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 space-y-8">
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="text-[var(--color-dark-03)] leading-relaxed text-justify">
                            {service.description}
                        </p>
                    </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            {service.facility.map((item, idx) => (
                                <div key={idx} className="bg-[var(--color-dark-07)] p-8 rounded-xl border-t-2 border-[var(--color-primary)]">
                                    ...
                                    <p className="text-[var(--color-dark-03)] text-sm leading-relaxed">{item.details}</p>
                                </div>
                            ))}
                        </div>
                    )}
                    ...
                    <div className="space-y-4 pt-2">
                        ...
                        <p className="text-[var(--color-dark-03)] leading-relaxed">
                ...
                <div className="space-y-8">
                                ...
                                return (
                                    <Link
                                        ...
                                        className={`flex items-center justify-between p-4 rounded-lg font-semibold transition-all ${isActive
                                            ...
                                            : 'bg-white text-[var(--color-dark-01)] hover:bg-[var(--color-primary)] hover:text-white'
                                            }`}
                                    >
                    ...
                    {/* Downloads Section */}
                    <div className="bg-[var(--color-dark-01)] text-white p-8 rounded-xl space-y-5">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <button className="bg-[var(--color-primary)] p-3 rounded-md hover:bg-[var(--color-primary-hover)] transition-colors">
                    ...
                    {/* Promo Box */}
                    <div className="bg-[var(--color-dark-01)] text-white p-8 rounded-xl text-center space-y-6">
                        ...
                        <div className="bg-white text-[var(--color-dark-01)] p-6 rounded-xl space-y-2">
                            <h5 className="text-xl font-bold text-[var(--color-primary)]">
                                Car Doctor <span className="text-[var(--color-dark-01)]">Special</span>
                            </h5>
                            <p className="text-xs font-bold text-[var(--color-dark-03)]">
                                Save up to <span className="text-[var(--color-primary)]">60% off</span>
                            </p>
                            <div className="pt-2">
                                <button className="bg-[var(--color-primary)] hover:bg-[var(--color-primary-hover)] text-white px-5 py-2.5 rounded-md font-semibold text-sm transition-colors">
                                    Get A Quote
                                </button>
                            </div>
                        </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <Link href={`/checkout/${service._id}`} className="block">
                            <button className="w-full bg-[var(--color-primary)] hover:bg-[var(--color-primary-hover)] text-white font-semibold py-4 rounded-xl transition-colors">
                                Proceed Checkout
                            </button>
                        </Link>
                    </div>
